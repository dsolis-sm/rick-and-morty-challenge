...
public class RickAndMortyServiceImplTest {
	...
	public void findByIdOK() {
		...
		Optional<Root> expected = rickAndMortyService.findById(id);
	...
	public void findByIdOK2() {
		...
		Mockito.when(rickAndMortyClientRest.findById(id)).thenReturn(root);
		Mockito.when(rickAndMortyClientRest.findByLocation(id)).thenReturn(null);
	...
	public void findByIdNOK() {
		...
		rickAndMortyService.findById(id);
	}
	...
	public void findByLocationOK() {
		...
		Optional<Location> response = Optional.of(location);

		Mockito.when(rickAndMortyClientRest.findByLocation(id)).thenReturn(location);

		Optional<Location> expected = rickAndMortyService.findByLocation(id);
	...
	public void findByLocationNOK() {
		...
		rickAndMortyService.findByLocation(id);
